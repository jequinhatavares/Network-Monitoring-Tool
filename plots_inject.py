...
def plot_scatter_message_continuous2(df: pd.DataFrame,show_plot):
    ...
    middleware_message_subtype_mapping = {
        "INJECT_NODE_METRIC_UPDATE": "Node Metric Update",
        "INJECT_NETWORK_METRICS_UPDATE": "Network Metric Update",
...
if __name__ == '__main__':
    ...
    #nRun=0(before changes to routing) 27
    nRun = 27
    app_init_df, app_inference_df, message_continuous_df = get_dfs("logs/centralized_nn_12_strategy_inject",nRun)
